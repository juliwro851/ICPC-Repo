...
def main():
    ...
    config = (
        ...
        .env_runners(
        num_env_runners=env_config.get("num_env_runners", 2),  # > 0
        )
        .training(
            lr=args.lr,
            gamma=args.gamma,
...
#     # Heterogeneous training with 2 rescuers, 2 firefighters
# python train_heterogeneous_rllib.py --hetero --rescuers 2 --firefighters 2 --iters 50

# # Homogeneous baseline for comparison  
# python train_heterogeneous_rllib.py --agents 4 --iters 50

# # Custom learning parameters
# python train_heterogeneous_rllib.py --hetero --lr 3e-4 --gamma 0.95 --batch_size 8000